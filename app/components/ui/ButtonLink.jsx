import { ShoppingCart, Plus, Zap, ArrowRight } from "lucide-react";
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        color === "orange" &&
          "from-[#D4AF37] to-[#EAE0D5] text-black hover:text-black",
        color === "purple" &&
          "from-purple-500 to-lime-500 text-white hover:text-black",
        color === "lime" && "from-lime-500 to-orange-500 text-black",
        className
      )}
      {...props}
    >
